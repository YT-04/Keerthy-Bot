...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/+1qdEeHOTLdQ1M2Vl"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/+1qdEeHOTLdQ1M2Vl")
            ])
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase 👉 Request to bot Owner @Keerthy_Admin_Bot ')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/+1qdEeHOTLdQ1M2Vl'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/+1qdEeHOTLdQ1M2Vl')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/+1qdEeHOTLdQ1M2Vl')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/+1qdEeHOTLdQ1M2Vl'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/+1qdEeHOTLdQ1M2Vl')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Adult Bot 🔞', url='https://t.me/+1qdEeHOTLdQ1M2Vl')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/+1qdEeHOTLdQ1M2Vl'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/+1qdEeHOTLdQ1M2Vl")
    ])
    ...
    if imdb:
        ...
        cap = f"<b>🎬 Title:</b> {search}\n</b>\n<b><a href='https://t.me/+q9NMdy0rY10zZWZl'>© IMDb (Series & Movies) Studio</a></b>\n\n<b>✍️ Note:</b> <s>This message will be Auto-deleted after 12 hours to avoid copyright issues.</s>"
